...
export default function Page404() {
  return (
    <div className='d-flex flex-column align-items-center mt-4 mb-4'>
        ...
        <p className='text-capitalize text-center fs-5'>but we are here to help!<br/>either use button bellow to head home,<br/>or use links in header of footer to go to your desired location.</p>
        <Link to={'/'}>
