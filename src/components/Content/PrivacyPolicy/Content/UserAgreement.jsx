...
export default function UserAgreement() {
  return (
    <div className="container d-flex flex-column">
      <h1 className="fw-bold">User Agreement</h1>
      <h2 className="fw-bold border-bottom border-3">
        PetUnion User Agreement
      </h2>
      <div className="row">
      <div className="col-9">
      <small className="m-1 border-bottom border-3">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Velit scelerisque in dictum non consectetur a erat. Nunc congue nisi vitae suscipit tellus mauris a diam. Rutrum tellus pellentesque eu tincidunt tortor. Sem nulla pharetra diam sit amet nisl suscipit. Nisi lacus sed viverra tellus in hac habitasse platea dictumst. Lacus luctus accumsan tortor posuere ac ut consequat semper. Cras ornare arcu dui vivamus. Commodo sed egestas egestas fringilla. Mus mauris vitae ultricies leo integer malesuada nunc vel risus.
      </small>
      <small className="m-1">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Velit scelerisque in dictum non consectetur a erat. Nunc congue nisi vitae suscipit tellus mauris a diam. Rutrum tellus pellentesque eu tincidunt tortor. Sem nulla pharetra diam sit amet nisl suscipit. Nisi lacus sed viverra tellus in hac habitasse platea dictumst. Lacus luctus accumsan tortor posuere ac ut consequat semper. Cras ornare arcu dui vivamus. Commodo sed egestas egestas fringilla. Mus mauris vitae ultricies leo integer malesuada nunc vel risus.
      </small>
