...
export default function Jobs(props) {
  return (
    <Link className="rounded-5 job-card p-4 pt-0 pb-0 m-1 d-flex flex-column justify-content-evenly" style={{flex:"45%"}} to={`/Jobs/${props.id}`}>
...
<img className="me-2 job-card-img" style={{"width":"2rem","height":"2rem"}} src={props.icon} alt={props.title}></img>
      <h5 className="text-dark job-card-title mt-3">{props.title}</h5>
      </div>
